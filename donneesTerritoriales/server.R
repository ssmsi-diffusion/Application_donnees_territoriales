...
uni.com = tibble("classe" = c("Homicides",
                              "Coups et blessures volontaires",
                              "Coups et blessures volontaires intrafamiliaux",
                              "Coups et blessures volontaires en dehors du cadre familial",
                              "Violences sexuelles",
                              "Vols avec armes",
                              ...
                              "Trafic de stupéfiants"), "uni.com" = c("de victimes",
                                                                      "de victimes",
                                                                      "de victimes",
                                                                      "de victimes",
                                                                      "de victimes",
...
shinyServer(function(input,output,session) { 
  ...
  texteCommune = reactive({
    ...
    paste0(libelleCommuneChoisie()," (",libelleDepCommuneChoisie(),", région ",libelleRegCommuneChoisie(),")"," est une commune qui recense ", poplibelleCommuneChoisie()," habitants en 2019,"," elle est située ",libelleTuuTxtCommuneChoisie(),". Le type d'agglomération auquel la commune est comparée, est défini en fonction de la taille de l'unité urbaine à laquelle la commune appartient (voir onglet documentation).")
